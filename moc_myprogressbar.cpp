...
QT_MOC_LITERAL(1, 14, 12), // "showProgress"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 12), // "hideProgress"
QT_MOC_LITERAL(4, 41, 8), // "nextStep"
QT_MOC_LITERAL(5, 50, 4) // "step"

    },
    "MyProgressBar\0showProgress\0\0hideProgress\0"
    "nextStep\0step"
};
...
void MyProgressBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->showProgress(); break;
        case 1: _t->hideProgress(); break;
        case 2: _t->nextStep((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
